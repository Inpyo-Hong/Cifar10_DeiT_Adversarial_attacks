...
# 모델 초기화하기
teacher_path = "../teacher_model/best_Regnety160-8.pth"
...
def test( model, device, test_loader, epsilon ):
    ...
    for i, data in loop:
        ...
        plt.axis('off')
        plt.savefig('C:/teacher_model_FGSM/test/' + str(epsilon) + '/' + label_class + '/' + str(i) + '.png', bbox_inches='tight', pad_inches=0)
...
for eps in epsilons:
    acc = test(teacher_model, device, test_loader, eps)
